...
(function(){
   ...
   */
  // Group share view extracted to js/views/group-share-view.js (2026-06-03)
  function showNoGroupModal() { window.showNoGroupModal?.(); }
  function showShareItineraryModal() { window.showShareItineraryModal?.(); }
  function sharePersonalItineraryToGroup(roomId) { window.sharePersonalItineraryToGroup?.(roomId); }
  function editGroupItinerary(id) { window.editGroupItinerary?.(id); }
  function showGroupItineraryEditor(id, it) { window.showGroupItineraryEditor?.(id, it); }
  function escapeHtml(s) { return window.escapeHtml?.(s) ?? (s || '').replace(/[&<>"']/g, c => ({'&':'&amp;','<':'&lt;','>':'&gt;','"':'"',"'":'&#39;'})[c]); }
  // ═════════════════════════════════════════════════════════════════
