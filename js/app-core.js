...
(function(){
  ...
  function fetchOpeningHoursFromGooglePlaces(poi) { return window.fetchOpeningHoursFromGooglePlaces?.(poi) ?? null; }
  function parseOpeningHoursString(str) { return window.parseOpeningHoursString?.(str) ?? null; }
  function formatOpeningHoursArray(arr) { return window.formatOpeningHoursArray?.(arr) ?? null; }
  function setPOIOpeningHours(itineraryId, googlePlaceId, openingHoursData) { window.setPOIOpeningHours?.(itineraryId, googlePlaceId, openingHoursData); }
  function getPOIOpeningHours(itineraryId, googlePlaceId) { return window.getPOIOpeningHours?.(itineraryId, googlePlaceId) ?? null; }
  function isPOICurrentlyOpen(itineraryId, googlePlaceId) { return window.isPOICurrentlyOpen?.(itineraryId, googlePlaceId) ?? null; }
