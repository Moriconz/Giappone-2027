...
(function() {
  ...
  style.textContent = `
    ...
    .y2k-win-body .poi-row { display: flex !important; flex-direction: row !important; align-items: center !important; gap: 12px !important; padding: 10px 12px !important; background: linear-gradient(135deg, rgba(60, 40, 30, 0.25), rgba(50, 35, 25, 0.15)) !important; border: 1px solid rgba(255, 140, 80, 0.2) !important; border-radius: 10px !important; min-height: 64px !important; transition: all 0.2s ease !important; overflow: visible !important; }
    ...
    .y2k-win-body .poi-row img { flex: 0 0 56px; width: 56px; height: 56px; border-radius: 8px; object-fit: cover; }
    .y2k-win-body .poi-row .icon { display: none; }
    .y2k-win-body .poi-row .body { flex: 1 1 auto; display: flex; flex-direction: column; justify-content: center; min-width: 0; gap: 2px; overflow: hidden; }
    .y2k-win-body .poi-row .body .name { color: #fff !important; font-weight: 600 !important; font-size: 14px !important; line-height: 1.2; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: block; }
    .y2k-win-body .poi-row .body .sub { color: rgba(255, 200, 140, 0.7) !important; font-size: 12px !important; line-height: 1.2; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: block; }
    .y2k-win-body .poi-row .btn { flex: 0 0 auto; width: auto; min-width: 80px; height: 36px; padding: 6px 14px; background: linear-gradient(135deg, #e87c3e, #d96a2e); border: 1px solid rgba(232, 124, 62, 0.5); border-radius: 20px; color: #fff; font-weight: 600; font-size: 13px; cursor: pointer; transition: all 0.2s ease; display: flex; align-items: center; justify-content: center; white-space: nowrap; }
