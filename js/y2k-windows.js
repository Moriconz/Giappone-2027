...
(function() {
  ...
  style.textContent = `
    ...
    .y2k-win-body .poi-row .btn { flex-shrink: 0; order: 3; min-width: 44px; height: 36px; padding: 4px 10px; background: linear-gradient(135deg, #e87c3e, #d96a2e); border: 1px solid rgba(232, 124, 62, 0.5); border-radius: 6px; color: #fff; font-weight: 600; font-size: 11px; cursor: pointer; transition: all 0.2s ease; display: flex; align-items: center; justify-content: center; white-space: nowrap; }
