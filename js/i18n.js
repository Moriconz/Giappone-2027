...
(function () {
  ...
  const DICT = {
    ...
    en: {
      ...
      'gfm.title': 'Group GF menu photos', 'gfm.empty': 'No photo. Snap the gluten-free menu for the group.', 'gfm.add': 'Add menu photo', 'gfm.added': '📷 GF menu shared with the group', 'gfm.err': '❌ Photo error', 'gfm.tooBig': '⚠️ Photo too large, retry with less detail', 'menu.checklist': 'Group checklist', 'ck.title': 'Group checklist', 'ck.done': 'done', 'ck.doneBy': 'done by', 'ck.placeholder': 'e.g. book a GF restaurant in Kyoto', 'ck.empty': 'Empty list. Add together what to pack and do.', 'ck.seed': 'Add GF preset', 'menu.expenses': 'Group expenses', 'exp.title': 'Group expenses', 'exp.balances': 'Balances', 'exp.total': 'Total', 'exp.whoOwes': 'Who owes whom', 'exp.allSettled': '✅ All settled, nothing owed', 'exp.add': 'Add expense', 'exp.addBtn': '+ Add expense', 'exp.descPh': 'e.g. GF ramen dinner', 'exp.paidBy': 'paid by', 'exp.splitN': 'split among', 'exp.splitHint': 'Split equally among all group members.', 'exp.history': 'Expenses', 'exp.invalid': '⚠️ Enter description and amount', 'exp.added': '💴 Expense added', 'exp.noMembers': 'No members', 'menu.budget': 'Budget', 'menu.gallery': 'Gallery', 'menu.groqai': 'Groq AI',
