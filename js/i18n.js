...
(function () {
  ...
  const DICT = {
    it: {
      ...
      'menu.tips': 'Tips Viaggio 2027', 'menu.gfHeatmap': 'Heatmap GF', 'menu.backup': 'Backup & Ripristino', 'menu.errors': 'Errori (debug)', 'menu.language': 'Lingua',
    ...
    en: {
      ...
      'menu.tips': 'Japan 2027 Tips', 'menu.gfHeatmap': 'GF Heatmap', 'menu.backup': 'Backup & Restore', 'menu.errors': 'Errors (debug)', 'menu.language': 'Language',
    ...
    ja: {
      ...
      'menu.tips': '日本2027 Tips', 'menu.gfHeatmap': 'GFヒートマップ', 'menu.backup': 'バックアップ＆復元', 'menu.errors': 'エラー（デバッグ）', 'menu.language': '言語',
