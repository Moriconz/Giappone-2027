...
(function () {
  ...
  const DICT = {
    it: {
      ...
      'pres.one': 'sta guardando', 'pres.many': 'stanno guardando', 'group.e2ee': 'E2EE', 'group.encrypted': 'Messaggi cifrati end-to-end col codice stanza', 'lang.label': 'Lingua',
      ...
      'groq.serverError': '❌ Errore Groq: {msg}', 'groq.error': '❌ Errore: {msg}', 'groq.imgServerError': '❌ Errore immagine: {msg}',
    ...
    en: {
      ...
      'pres.one': 'is viewing', 'pres.many': 'are viewing', 'group.e2ee': 'E2EE', 'group.encrypted': 'Messages end-to-end encrypted with the room code', 'lang.label': 'Language',
      ...
      'groq.serverError': '❌ Groq error: {msg}', 'groq.error': '❌ Error: {msg}', 'groq.imgServerError': '❌ Image error: {msg}',
    ...
    ja: {
      ...
      'pres.one': 'が閲覧中', 'pres.many': '人が閲覧中', 'group.e2ee': 'E2EE', 'group.encrypted': 'ルームコードでメッセージをエンドツーエンド暗号化', 'lang.label': '言語',
      ...
      'groq.serverError': '❌ Groqエラー：{msg}', 'groq.error': '❌ エラー：{msg}', 'groq.imgServerError': '❌ 画像エラー：{msg}',
